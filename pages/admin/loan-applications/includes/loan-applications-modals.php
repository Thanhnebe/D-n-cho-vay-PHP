            ...
            <div class="modal-body">
                ...
                <div id="modal-content" style="display: none;">
                    ...
                    <div id="approval-form-container" style="display: none;">
                        <form id="approvalForm" method="POST" action="?page=loan-applications&action=approve_with_contract">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="modal-approval-level" class="form-label">Cấp duyệt</label>
                                        <input type="number" class="form-control" id="modal-approval-level" name="approval_level" value="1" min="1" max="5" readonly>
                                    </div>
                                </div>
                            </div>
                        </form>
